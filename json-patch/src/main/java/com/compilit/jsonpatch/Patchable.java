...
/**
 * Apply this annotation to any field in a class that implements the PatchableEntity interface. This
 * will allow you to define exactly which fields can be patched and with what operation s this can
 * be done
 */
