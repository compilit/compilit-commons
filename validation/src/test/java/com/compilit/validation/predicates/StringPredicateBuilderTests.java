...
import static com.compilit.validation.predicates.StringPredicate.contains;
import static com.compilit.validation.predicates.StringPredicate.containsOnly;
import static com.compilit.validation.predicates.StringPredicate.doesNotContain;
import static com.compilit.validation.predicates.StringPredicate.hasALengthBetween;
import static com.compilit.validation.predicates.StringPredicate.hasALengthOf;
import static com.compilit.validation.predicates.StringPredicate.isAlphabetic;
import static com.compilit.validation.predicates.StringPredicate.isEqualTo;
import static com.compilit.validation.predicates.StringPredicate.isNotAlphabetic;
...
import static com.compilit.validation.predicates.StringPredicate.isNotNumeric;
import static com.compilit.validation.predicates.StringPredicate.isNullEmptyOrBlank;
import static com.compilit.validation.predicates.StringPredicate.isNumeric;
...
class StringPredicateBuilderTests {
  ...
  public static Stream<Arguments> validTestCases() {
    return Stream.of(
      ...
      arguments(
        defineThatIt(hasALengthOf(TEST_CONTENT.length()).and(contains("t"))).otherwiseReport("failure"),
        TEST_CONTENT
      ),
