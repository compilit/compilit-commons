...
class ApiUsageExampleTests extends AbstractTestWithContext {
  ...
  private final Rule<String> passwordRule = defineThatIt(StringPredicate.contains("#", "%", "*", "(")
  ...
  void validate_goodPassword_shouldReturnTrue() {
    ...
    var passwordRule = defineThatIt(StringPredicate.contains("#", "%", "*", "(")
  ...
  void alphabeticInputValidationUseCase_validInput_shouldNotThrowException() {
    var alphabeticStringRule1 = defineThatIt(StringPredicate.isAlphabetic()).otherwiseReport(FAIL_MESSAGE);
    var alphabeticStringRule2 = defineThatIt(StringPredicate.isNotNumeric()).otherwiseReport(FAIL_MESSAGE);
    var alphabeticStringRule3 = defineThatIt(StringPredicate.isAlphabetic()
