...
class ObjectPredicateTests {
  ...
  void isEqualTo_validInput_shouldReturnTrue() {
    Assertions.assertThat(isEqualTo("test").test("test")).isTrue();
  }

  @Test
  void isEqualTo_invalidInput_shouldReturnFalse() {
    Assertions.assertThat(isEqualTo("test").test("Something else")).isFalse();
  }

  @Test
  void isNotEqualTo_validInput_shouldReturnTrue() {
    Assertions.assertThat(isNotEqualTo("test").test("Something else")).isTrue();
  }

  @Test
  void isNotEqualTo_invalidInput_shouldReturnFalse() {
    Assertions.assertThat(isNotEqualTo("test").test("test")).isFalse();
  }
